...
/** Exception for LinearProgrammingSolver issues.
 **/

public class LinearProgrammingSolverException extends RuntimeException
{
    /** Create a new LinearProgrammingSolverException specifying the reason by a message.
     ** @param mes the message.
     **/
    public LinearProgrammingSolverException(String mes)
    {
        super(mes);
    }
}
