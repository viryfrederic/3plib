...
/** Exception for PolygonalProjector issues.
 **/

public class PolygonalProjectorException extends RuntimeException
{
    /** Create a new PolygonalProjectorException specifying the reason by a message.
     ** @param mes the message.
     **/
    public PolygonalProjectorException(String mes)
    {
        super(mes);
    }
}
