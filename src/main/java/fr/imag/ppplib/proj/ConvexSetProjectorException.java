...
/** Exception for ConvexSetProjector issues.
 **/

public class ConvexSetProjectorException extends RuntimeException
{
    /** Create a new ConvexSetProjectorException specifying the reason by a message.
     ** @param mes the message.
     **/
    public ConvexSetProjectorException(String mes)
    {
        super(mes);
    }
}
