...
public class MultithreadsConvexSetProjector implements ConvexSetProjector
{
     ...
     ** @exception ConvexSetProjectorException throws if the convex described by the support function lives in a different vectorspace than the plane, or the error is absolute and negative (0 included), or the error is relative and not in ]0, 1].
     ** @exception ConvexSetProjectorException thrown if some computations are impossible with the given error, or if multithreading fails, or if the convex set is empty.
     **/
     ...
     ** @return the polygon.
     ** @exception ConvexSetProjectorException thrown if no computation has been made yet.
     **/
    ...
    /** Provide a new instance of the implementation of the ConvexSetProjector, with the same threads number.
     ** @return the instance.
     **/
