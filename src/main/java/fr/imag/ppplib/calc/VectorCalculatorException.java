...
/** Exception for VectorCalculator issues.
 **/

public class VectorCalculatorException extends RuntimeException
{
    /** Create a new VectorCalculatorException specifying the reason by a message.
     ** @param mes the message.
     **/
    public VectorCalculatorException(String mes)
    {
        super(mes);
    }
}
