...
/** Exception for SupportFunction issues.
 **/

public class SupportFunctionException extends RuntimeException
{
    /** Create a new SupportFunctionException specifying the reason by a message.
     ** @param mes the message.
     **/
    public SupportFunctionException(String mes)
    {
        super(mes);
    }
}
