...
/** Exception for MatrixCalculator issues.
 **/

public class MatrixCalculatorException extends RuntimeException
{
    /** Create a new MatrixCalculatorException specifying the reason by a message.
     ** @param mes the message.
     **/
    public MatrixCalculatorException(String mes)
    {
        super(mes);
    }
}
