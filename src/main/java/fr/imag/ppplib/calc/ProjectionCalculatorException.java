...
/** Exception for ProjectionCalculator issues.
 **/

public class ProjectionCalculatorException extends RuntimeException
{
    /** Create a new ProjectionCalculatorException specifying the reason by a message.
     ** @param mes the message.
     **/
    public ProjectionCalculatorException(String mes)
    {
        super(mes);
    }
}
